...
const companiesData = {
    ...
    'winline': {
        ...
        financials: {
            ...
            '2020': {
                revenue: { value: 47.946754, unit: 'млрд', change: null },
                market_share: { value: 20.15, unit: '%', change: null, changeKind: 'pp' },
                winnings: { value: 37.70936, unit: 'млрд', change: null },
                ggr: { value: 10.237394, unit: 'млрд', change: null },
                ggr_margin: { value: 21.35, unit: '%', change: null, changeKind: 'pp' },
                profit: { value: 3989.677, unit: 'млн', change: null },
            ...
            '2021': {
                revenue: { value: 111.161, unit: 'млрд', change: 131.8 },
                market_share: { value: 15.05, unit: '%', change: -5.1, changeKind: 'pp' },
                winnings: { value: 89.093871, unit: 'млрд', change: 136.3 },
                ggr: { value: 22.067129, unit: 'млрд', change: 115.6 },
                ggr_margin: { value: 19.85, unit: '%', change: -1.5, changeKind: 'pp' },
                profit: { value: 9905.097, unit: 'млн', change: 148.27 },
                target_contributions: { value: '—', unit: '', change: null },
            ...
            '2022': {
                revenue: { value: 166.095865, unit: 'млрд', change: 49.4 },
                market_share: { value: 18.89, unit: '%', change: 3.84, changeKind: 'pp' },
                winnings: { value: 132.425226, unit: 'млрд', change: 48.6 },
                ggr: { value: 33.670639, unit: 'млрд', change: 52.6 },
                ggr_margin: { value: 20.27, unit: '%', change: 0.42, changeKind: 'pp' },
                profit: { value: 13138, unit: 'млн', change: 32.64 },
            ...
            '2023': {
                revenue: { value: 277.265386, unit: 'млрд', change: 66.9 },
                market_share: { value: 22.73, unit: '%', change: 3.84, changeKind: 'pp' },
                winnings: { value: 206.113535, unit: 'млрд', change: 55.6 },
                ggr: { value: 71.151851, unit: 'млрд', change: 111.3 },
                ggr_margin: { value: 25.66, unit: '%', change: 5.39, changeKind: 'pp' },
                profit: { value: 26863.58, unit: 'млн', change: 104.47 },
            ...
            '2024': {
                revenue: { value: 414.987076, unit: 'млрд', change: 49.7 },
                market_share: { value: 23.92, unit: '%', change: 1.19, changeKind: 'pp' },
                winnings: { value: 315.07056, unit: 'млрд', change: 52.9 },
                ggr: { value: 99.916516, unit: 'млрд', change: 40.4 },
                ggr_margin: { value: 24.08, unit: '%', change: -1.58, changeKind: 'pp' },
                profit: { value: 27748.572, unit: 'млн', change: 3.29 },
            ...
            '2025': {
                revenue: { value: 409.281466, unit: 'млрд', change: -1.4 },
                market_share: { value: 21.63, unit: '%', change: -2.29, changeKind: 'pp' },
                winnings: { value: 307.885868, unit: 'млрд', change: -2.3 },
                ggr: { value: 101.395598, unit: 'млрд', change: 1.5 },
                ggr_margin: { value: 24.77, unit: '%', change: 0.69, changeKind: 'pp' },
                profit: { value: 24604.576, unit: 'млн', change: -11.33 },
    ...
    'sportbet': {
        name: 'Спортбет',
        logo: 'https://dumpster.cdn.sports.ru/9/ed/795d453bbc0d698d4fc9a0a786499.png',
        founded: '1999',
        entity: 'Акционерное общество «СпортБет»',
        financials: {
            '2020': {
                revenue: { value: 2.243579, unit: 'млрд', change: null },
                market_share: { value: 0.94, unit: '%', change: null, changeKind: 'pp' },
                winnings: { value: 1.302183, unit: 'млрд', change: null },
                ggr: { value: 0.941396, unit: 'млрд', change: null },
                ggr_margin: { value: 41.96, unit: '%', change: null, changeKind: 'pp' },
                profit: { value: -89.405, unit: 'млн', change: null },
                target_contributions: { value: 60, unit: 'млн', change: null },
                salaries: { value: 258.904, unit: 'млн', change: null }
            },
            '2021': {
                revenue: { value: 1.832226, unit: 'млрд', change: -18.3 },
                market_share: { value: 0.25, unit: '%', change: -0.69, changeKind: 'pp' },
                winnings: { value: 0.785913, unit: 'млрд', change: -39.6 },
                ggr: { value: 1.046313, unit: 'млрд', change: 11.1 },
                ggr_margin: { value: 57.11, unit: '%', change: 15.15, changeKind: 'pp' },
                profit: { value: -68.828, unit: 'млн', change: -23.02 },
                target_contributions: { value: '—', unit: '', change: null },
                salaries: { value: 216.997, unit: 'млн', change: -16.2 }
            },
            '2022': {
                revenue: { value: 1.964109, unit: 'млрд', change: 7.2 },
                market_share: { value: 0.22, unit: '%', change: -0.03, changeKind: 'pp' },
                winnings: { value: 0.673527, unit: 'млрд', change: -14.3 },
                ggr: { value: 1.290582, unit: 'млрд', change: 23.3 },
                ggr_margin: { value: 65.71, unit: '%', change: 8.6, changeKind: 'pp' },
                profit: { value: 143.808, unit: 'млн', change: -308.94 },
                target_contributions: { value: 120, unit: 'млн', change: null },
                salaries: { value: 306.869, unit: 'млн', change: 41.4 }
            },
            '2023': {
                revenue: { value: 2.475186, unit: 'млрд', change: 26.0 },
                market_share: { value: 0.20, unit: '%', change: -0.02, changeKind: 'pp' },
                winnings: { value: 0.711792, unit: 'млрд', change: 5.7 },
                ggr: { value: 1.763394, unit: 'млрд', change: 36.6 },
                ggr_margin: { value: 71.24, unit: '%', change: 5.53, changeKind: 'pp' },
                profit: { value: 325.979, unit: 'млн', change: 126.68 },
                target_contributions: { value: 120, unit: 'млн', change: 0 },
                salaries: { value: 399.521, unit: 'млн', change: 30.2 }
            },
            '2024': {
                revenue: { value: 1.920775, unit: 'млрд', change: -22.4 },
                market_share: { value: 0.11, unit: '%', change: -0.09, changeKind: 'pp' },
                winnings: { value: 0.43262, unit: 'млрд', change: -39.2 },
                ggr: { value: 1.488155, unit: 'млрд', change: -15.6 },
                ggr_margin: { value: 77.48, unit: '%', change: 6.24, changeKind: 'pp' },
                profit: { value: -53.98, unit: 'млн', change: -116.56 },
                target_contributions: { value: 120, unit: 'млн', change: 0 },
                salaries: { value: 549.602, unit: 'млн', change: 37.6 }
            },
            '2025': {
                revenue: { value: 2.243937, unit: 'млрд', change: 16.8 },
                market_share: { value: 0.12, unit: '%', change: 0.01, changeKind: 'pp' },
                winnings: { value: '—', unit: '', change: null },
                ggr: { value: '—', unit: '', change: null },
                ggr_margin: { value: '—', unit: '', change: null, changeKind: 'pp' },
                profit: { value: 33.35, unit: 'млн', change: -161.78 },
                target_contributions: { value: 120, unit: 'млн', change: 0 },
                salaries: { value: 694.755, unit: 'млн', change: 26.4 }
            }
        }
    },
    'melbet': {
    ...
    'marathon': { 
        ...
        financials: { 
            '2020': { 
                ...
                winnings: { value: 3.50, unit: 'млрд', change: null },
                ggr_margin: { value: 13.84, unit: '%', change: null, changeKind: 'pp' },
                market_share: { value: 1.71, unit: '%', change: null },
                profit: { value: 0.18, unit: 'млрд', change: null },
                target_contributions: { value: 0, unit: 'млн', change: null },
                salaries: { value: 32.381, unit: 'млн', change: null },
                advertising: { value: '—', unit: '', change: null }
            },
            '2021': { 
                revenue: { value: 12.26, unit: 'млрд', change: 201.7 }, 
                ggr: { value: 2.59, unit: 'млрд', change: 360.7 },
                winnings: { value: 9.66, unit: 'млрд', change: 176.0 },
                ggr_margin: { value: 21.17, unit: '%', change: 7.33, changeKind: 'pp' },
                market_share: { value: 1.66, unit: '%', change: -0.05, changeKind: 'pp' },
                profit: { value: 1.39, unit: 'млрд', change: 672.2 },
                target_contributions: { value: 110.406, unit: 'млн', change: null },
                salaries: { value: 41.113, unit: 'млн', change: 27.0 },
                advertising: { value: '—', unit: '', change: null }
            },
            '2022': { 
                revenue: { value: 13.64, unit: 'млрд', change: 11.3 }, 
                ggr: { value: 3.34, unit: 'млрд', change: 29.0 },
                winnings: { value: 10.30, unit: 'млрд', change: 6.6 },
                ggr_margin: { value: 24.48, unit: '%', change: 3.31, changeKind: 'pp' },
                market_share: { value: 1.55, unit: '%', change: -0.11, changeKind: 'pp' },
                profit: { value: 0.51, unit: 'млрд', change: -63.3 },
                target_contributions: { value: 204.091, unit: 'млн', change: 84.9 },
                salaries: { value: 43.668, unit: 'млн', change: 6.2 },
                advertising: { value: '—', unit: '', change: null }
            }, 
            '2023': { 
                revenue: { value: 18.20, unit: 'млрд', change: 33.4 }, 
                ggr: { value: 4.28, unit: 'млрд', change: 28.1 },
                winnings: { value: 13.92, unit: 'млрд', change: 35.1 },
                ggr_margin: { value: 23.52, unit: '%', change: -0.96, changeKind: 'pp' },
                market_share: { value: 1.49, unit: '%', change: -0.06, changeKind: 'pp' },
                profit: { value: 0.24, unit: 'млрд', change: -53.1 },
                target_contributions: { value: 273.811, unit: 'млн', change: 34.2 },
                salaries: { value: 51.398, unit: 'млн', change: 17.7 },
                advertising: { value: 257.106, unit: 'млн', change: null }
            }, 
            '2024': { 
                revenue: { value: 18.73, unit: 'млрд', change: 2.9 }, 
                ggr: { value: 5.02, unit: 'млрд', change: 17.3 },
                winnings: { value: 13.70, unit: 'млрд', change: -1.5 },
                ggr_margin: { value: 26.82, unit: '%', change: 3.3, changeKind: 'pp' },
                market_share: { value: 1.08, unit: '%', change: -0.41, changeKind: 'pp' },
                profit: { value: 0.79, unit: 'млрд', change: 229.2 },
                target_contributions: { value: 374.357, unit: 'млн', change: 36.7 },
                salaries: { value: 45.741, unit: 'млн', change: -11.0 },
                advertising: { value: 233.851, unit: 'млн', change: -9.8 }
            },
            '2025': {
                revenue: { value: 19.20, unit: 'млрд', change: 2.5 },
                ggr: { value: 5.17, unit: 'млрд', change: 2.9 },
                winnings: { value: 14.03, unit: 'млрд', change: 2.4 },
                ggr_margin: { value: 26.90, unit: '%', change: 0.08, changeKind: 'pp' },
                market_share: { value: 1.01, unit: '%', change: -0.07, changeKind: 'pp' },
                profit: { value: 0.36, unit: 'млрд', change: -54.6 },
                target_contributions: { value: 382.409, unit: 'млн', change: 2.2 },
                salaries: { value: 39.033, unit: 'млн', change: -14.7 },
                advertising: { value: 207.087, unit: 'млн', change: -11.4 }
            } 
        } 
    },
    'tennisi': {
        ...
        financials: {
            // Входные значения в таблице — в тыс. руб, поэтому переводим в млрд: value / 1e6.
            '2019': {
                revenue: { value: 0.467493, unit: 'млрд', change: null },
                market_share: { value: 0.34, unit: '%', change: null, changeKind: 'pp' },
                winnings: { value: 0.305540, unit: 'млрд', change: null },
                ggr: { value: 0.161953, unit: 'млрд', change: null },
                ggr_margin: { value: 34.64, unit: '%', change: null, changeKind: 'pp' },
                profit: { value: 0.008520, unit: 'млрд', change: null },
                target_contributions: { value: 60, unit: 'млн', change: null },
                salaries: { value: 0.047114, unit: 'млрд', change: null },
                commercial: { value: 0.078519, unit: 'млрд', change: null }
            },
            '2020': {
                revenue: { value: 0.459110, unit: 'млрд', change: -1.8 },
                market_share: { value: 0.19, unit: '%', change: -0.15, changeKind: 'pp' },
                winnings: { value: 0.272589, unit: 'млрд', change: -10.8 },
                ggr: { value: 0.186521, unit: 'млрд', change: 15.2 },
                ggr_margin: { value: 40.63, unit: '%', change: 5.99, changeKind: 'pp' },
                profit: { value: 0.065603, unit: 'млрд', change: 670.0 },
                target_contributions: { value: 60, unit: 'млн', change: 0.0 },
                salaries: { value: 0.069251, unit: 'млрд', change: 47.0 },
                commercial: { value: 0.050003, unit: 'млрд', change: -36.3 }
            },
            '2021': {
                revenue: { value: 2.491808, unit: 'млрд', change: 442.7 },
                market_share: { value: 0.34, unit: '%', change: 0.15, changeKind: 'pp' },
                winnings: { value: 1.831699, unit: 'млрд', change: 572.0 },
                ggr: { value: 0.660109, unit: 'млрд', change: 253.9 },
                ggr_margin: { value: 26.49, unit: '%', change: -14.14, changeKind: 'pp' },
                profit: { value: 0.137100, unit: 'млрд', change: 109.0 },
                target_contributions: { value: '—', unit: '', change: null },
                salaries: { value: 0.107813, unit: 'млрд', change: 55.7 },
                commercial: { value: 0.042903, unit: 'млрд', change: -14.2 }
            },
            '2022': {
                revenue: { value: 2.976484, unit: 'млрд', change: 19.5 },
                market_share: { value: 0.34, unit: '%', change: 0.0, changeKind: 'pp' },
                winnings: { value: 2.273764, unit: 'млрд', change: 24.1 },
                ggr: { value: 0.702720, unit: 'млрд', change: 6.5 },
                ggr_margin: { value: 23.61, unit: '%', change: -2.88, changeKind: 'pp' },
                profit: { value: 0.067292, unit: 'млрд', change: -50.9 },
                target_contributions: { value: 120, unit: 'млн', change: null },
                salaries: { value: 0.103887, unit: 'млрд', change: -3.6 },
                commercial: { value: 0.032369, unit: 'млрд', change: -24.6 }
            },
            '2023': {
                revenue: { value: 4.210300, unit: 'млрд', change: 41.5 },
                market_share: { value: 0.35, unit: '%', change: 0.01, changeKind: 'pp' },
                winnings: { value: 3.279264, unit: 'млрд', change: 44.2 },
                ggr: { value: 0.931036, unit: 'млрд', change: 32.5 },
                ggr_margin: { value: 22.11, unit: '%', change: -1.5, changeKind: 'pp' },
                profit: { value: 0.279413, unit: 'млрд', change: 315.2 },
                target_contributions: { value: 120, unit: 'млн', change: 0.0 },
                salaries: { value: 0.099541, unit: 'млрд', change: -4.2 },
                commercial: { value: 0.070396, unit: 'млрд', change: 117.5 }
            },
            '2024': {
                revenue: { value: 4.585536, unit: 'млрд', change: 8.9 },
                market_share: { value: 0.27, unit: '%', change: -0.08, changeKind: 'pp' },
                winnings: { value: 3.504084, unit: 'млрд', change: 6.9 },
                ggr: { value: 1.081452, unit: 'млрд', change: 16.2 },
                ggr_margin: { value: 23.58, unit: '%', change: 1.47, changeKind: 'pp' },
                profit: { value: 0.276435, unit: 'млрд', change: -1.1 },
                target_contributions: { value: 120, unit: 'млн', change: 0.0 },
                salaries: { value: 0.132767, unit: 'млрд', change: 33.4 },
                commercial: { value: 0.170328, unit: 'млрд', change: 142.0 }
            },
            '2025': {
                revenue: { value: 4.441934, unit: 'млрд', change: -3.1 },
                market_share: { value: 0.23, unit: '%', change: -0.04, changeKind: 'pp' },
                winnings: { value: 3.481641, unit: 'млрд', change: -0.6 },
                ggr: { value: 0.960293, unit: 'млрд', change: -11.2 },
                ggr_margin: { value: 21.62, unit: '%', change: -1.96, changeKind: 'pp' },
                profit: { value: -0.049283, unit: 'млрд', change: -117.8 },
                target_contributions: { value: 120, unit: 'млн', change: 0.0 },
                salaries: { value: 0.169928, unit: 'млрд', change: 28.0 },
                commercial: { value: 0.144149, unit: 'млрд', change: -15.4 }
            }
        }
    },
    'baltbet': { 
...
function buildMetricTitle(label, formattedMetric) {
    ...
    // Если метка уже содержит '(%)', нельзя добавлять второй '%' в скобки.
    // Пример: label = 'GGR (%)', unit = '%' => 'GGR (%)' (без ' (%)').
    if (u === '%' && label.includes('(%)')) return label;
...
function formatMetricValue(label, data) {
    ...
    // Для расходов/показателей “по деньгам” делаем авто-выбор единиц:
    // если значение >= 1 млрд — показываем в “млрд”, иначе — в “млн”.
    // Исходно данные могут быть в 'млн' / 'млрд' / 'тыс'.
    function formatMlnOrBlnMoney(data, cfg) {
        let valueInMln = data.value;
        const u = data.unit || 'млн';
        if (u === 'млрд') valueInMln = data.value * 1000;
        if (u === 'тыс') valueInMln = data.value / 1000;

        const sign = data.value < 0 ? '−' : '';
        const absInMln = Math.abs(valueInMln);

        if (absInMln >= 1000) {
            return {
                value: sign + (absInMln / 1000).toLocaleString('ru-RU', {
                    minimumFractionDigits: cfg.minBln,
                    maximumFractionDigits: cfg.maxBln
                }),
                unit: 'млрд'
            };
        }
        ...
        return {
            value: sign + absInMln.toLocaleString('ru-RU', {
                minimumFractionDigits: cfg.minMln,
                maximumFractionDigits: cfg.maxMln
            }),
            unit: 'млн'
        };
    }
    ...
    if (
        ...
        if (label === 'Целевые отчисления') {
            return formatMlnOrBlnMoney(data, { minBln: 1, maxBln: 2, minMln: 0, maxMln: 2 });
        }
        return formatMlnOrBlnMoney(data, { minBln: 0, maxBln: 2, minMln: 0, maxMln: 2 });
    }
