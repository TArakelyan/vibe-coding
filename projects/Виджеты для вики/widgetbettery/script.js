// Bettery Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('Bettery widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🎁 Эксклюзивный бонус от Bettery',
    ...
    const widget = document.querySelector('.bettery-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/wiki/posts/bettery', '_blank');
        console.log('Bettery widget clicked - redirecting to: https://spnsrd.ru/wiki/posts/bettery');
    });
