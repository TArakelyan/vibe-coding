...
document.addEventListener('DOMContentLoaded', function() {
    console.log('BETM widget loaded');
    ...
    const widget = document.querySelector('.betm-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/wiki/posts/ctaw/betm', '_blank');
        console.log('BETM widget clicked - redirecting to: https://spnsrd.ru/wiki/posts/ctaw/betm');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/wiki/posts/ctaw/betm');
    });
