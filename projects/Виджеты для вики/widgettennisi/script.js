// Тенниси Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('Тенниси widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '💰 БОНУС: до 20000₽ при регистрации!',
        '➡️ Подарки новым и активным игрокам',
        '💰 Бонус при регистрации в Tennisi'
    ];
    ...
    const widget = document.querySelector('.tennisi-widget');
    const actionButton = document.querySelector('.action-button');
    
    // Клик по всему виджету
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/psttennisi', '_blank');
        console.log('Тенниси widget clicked - redirecting to: https://spnsrd.ru/psttennisi');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/psttennisi');
    });
