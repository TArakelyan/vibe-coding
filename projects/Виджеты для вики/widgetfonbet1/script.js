// FONBET Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('FONBET widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🏆 Получите бонус до 15000₽ от Фонбет',
        '💰 ТВОЙ БОНУС: фрибет на следующий матч',
        '🎁 Бесплатная ставка на следующий матч!',
        '🎁 Бонус при регистрации для новичков'
    ];
    ...
    const widget = document.querySelector('.fonbet-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/pst2fonbet', '_blank');
        console.log('FONBET widget clicked - redirecting to: https://spnsrd.ru/pst2fonbet');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/pst2fonbet');
    });
