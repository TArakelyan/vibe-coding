// WINLINE Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('WINLINE widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🏆 Фрибет 3000₽ всем новым игрокам',
        '💰 Бесплатная ставка за регистрацию',
        '🎁 ПОДАРОК: фрибет при регистрации',
        '💰 Твой фрибет при регистрации в WINLINE'
    ];
    ...
    const widget = document.querySelector('.winline-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/wiki/posts/text/winline', '_blank');
        console.log('WINLINE widget clicked - redirecting to: https://spnsrd.ru/wiki/posts/text/winline');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/wiki/posts/text/winline');
    });
