// LIGA STAVOK Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('LIGA STAVOK widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '👉🏻 Твой бонус: фрибет после регистрации!',
        '➡️ Бонус 7777₽ после регистрации',
        '💰 БОНУС: фрибет 7777₽ новым игрокам',
        '🎁 Фартовый фрибет до 7777₽'
    ];
    ...
    const widget = document.querySelector('.liga-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/pst1ligastavok', '_blank');
        console.log('LIGA STAVOK widget clicked - redirecting to: https://spnsrd.ru/pst1ligastavok');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/pst1ligastavok');
    });
