// BetBoom Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('BetBoom widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🎁 ПОДАРОК: до 10000₽ при регистрации!',
        '💰 Приветственный бонус от BetBoom',
        '💰 Бесплатная ставка до 10000₽',
        '➡️ Бонус при регистрации в BetBoom'
    ];
    ...
    const widget = document.querySelector('.betboom-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/pst2betboom', '_blank');
        console.log('BetBoom widget clicked - redirecting to: https://spnsrd.ru/pst2betboom');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/pst2betboom');
    });
