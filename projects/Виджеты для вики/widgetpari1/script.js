...
document.addEventListener('DOMContentLoaded', function() {
    console.log('PARI widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🏆 Повышенный бонус до 20 000 ₽ новым игрокам!',
        '🧤 Лови: бонус 20 000 ₽ для новичков',
        '🎁 ПОДАРОК: бонус до 20 000 ₽ новичкам',
        '💰 БОНУС: до 20 000 ₽ новым игрокам!'
    ];
    ...
    const widget = document.querySelector('.pari-widget');
    ...
    widget.addEventListener('click', function() {
        ...
        console.log('PARI widget clicked - redirecting to: https://spnsrd.ru/pst1pari');
    });
