// ОлимпБет Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('ОлимпБет widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🎁 Бонус: фрибет 8000₽ для новичков',
        '🏆 ПОДАРОК: фрибет при регистрации!',
        '🎁 Эксклюзивный бонус от OLIMPBET',
        '➡️ За фрибетом на следующий матч'
    ];
    ...
    const widget = document.querySelector('.olimpbet-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/pst2olimp', '_blank');
        console.log('ОлимпБет widget clicked - redirecting to: https://spnsrd.ru/pst2olimp');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/pst2olimp');
    });
