// БалтБет Widget Script
document.addEventListener('DOMContentLoaded', function() {
    console.log('БалтБет widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '🎁 Приветственный бонус до 20000₽',
        '💰 Бонус на следующий матч в Балтбет',
        '🎁 ПОДАРОК: до 20000₽ новым игрокам!'
    ];
    ...
    const widget = document.querySelector('.baltbet-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/wiki/posts/baltbet', '_blank');
        console.log('BetBoom widget clicked - redirecting to: https://spnsrd.ru/wiki/posts/baltbet');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/wiki/posts/baltbet');
    });
