...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Leon widget loaded');
    
    // Массив с текстами для ротации
    const rotationTexts = [
        '💝 Эксклюзивный бонус 1 000₽!',
        '💰 Фрибет 1 000₽ всем новым игрокам!',
        '🎁 Твоя бесплатная ставка на матч!'
    ];
    ...
    const widget = document.querySelector('.leon-widget');
    ...
    widget.addEventListener('click', function() {
        window.open('https://spnsrd.ru/wiki/posts/leon', '_blank');
        console.log('Leon widget clicked - redirecting to: https://spnsrd.ru/wiki/posts/leon');
    });
    ...
    actionButton.addEventListener('click', function(e) {
        ...
        console.log('Action button clicked - redirecting to: https://spnsrd.ru/wiki/posts/leon');
    });
